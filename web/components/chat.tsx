  ...
  return (
    <div className="relative mx-auto flex h-dvh max-w-3xl flex-col">
      ...
      <div className="relative z-10 border-t border-[var(--line)] bg-[var(--paper)]/80 p-4 backdrop-blur-sm">
        <div className="flex items-end gap-2 rounded-xl border border-[var(--line)] bg-[var(--surface)] p-2 shadow-[0_8px_24px_-16px_rgba(11,45,42,0.35)] focus-within:border-[var(--ink)]/30 focus-within:ring-2 focus-within:ring-[var(--ember)]/25">
          <textarea
            value={input}
